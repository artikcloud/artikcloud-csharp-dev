...
namespace CLOUD.Artik.Model
{
    ...
    public partial class TaskUpdateRequest :  IEquatable<TaskUpdateRequest>
    {
        ...
        public TaskUpdateRequest(string Status = null)
        {
            this.Status = Status;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaskUpdateRequest);
        }

        /// <summary>
        /// Returns true if TaskUpdateRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
