...
namespace CLOUD.Artik.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceTask :  IEquatable<DeviceTask>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceTask" /> class.
        /// </summary>
        ...
        public DeviceTask(int? NumAttempts = null, string ErrorMessage = null, string ErrorCode = null, string Did = null, string Status = null, long? Ts = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DeviceTask);
        }

        /// <summary>
        /// Returns true if DeviceTask instances are equal
        /// </summary>
        /// <param name="other">Instance of DeviceTask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceTask other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
