...
namespace CLOUD.Artik.Util
{
    internal class DictionaryConverter : JsonConverter
    {
        ...
        private object ReadValue(JsonReader reader)
        {
            ...
            {
                if (!reader.Read())
                    throw JsonSerializationExceptionCreate(reader,
                ...
                default:
                    ...
                    throw JsonSerializationExceptionCreate(reader,
                        string.Format(CultureInfo.InvariantCulture,
                            "Unexpected token when converting IDictionary<string, object>: {0}", reader.TokenType));
            }
        }
        ...
        private static JsonSerializationException JsonSerializationExceptionCreate(JsonReader reader, string message,
            Exception ex = null)
        {
        ...
        // based on internal Newtonsoft.Json.JsonSerializationException.Create
        private static JsonSerializationException JsonSerializationExceptionCreate(IJsonLineInfo lineInfo, string path,
