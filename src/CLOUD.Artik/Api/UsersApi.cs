...
namespace CLOUD.Artik.Api
{
    ...
    public interface IUsersApi : IApiAccessor
    {
        ...
        ApiResponse<RulesEnvelope> GetUserRulesWithHttpInfo (string userId, bool? excludeDisabled = null, int? count = null, int? offset = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<RulesEnvelope> GetUserRulesAsync (string userId, bool? excludeDisabled = null, int? count = null, int? offset = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<RulesEnvelope>> GetUserRulesAsyncWithHttpInfo (string userId, bool? excludeDisabled = null, int? count = null, int? offset = null);
        /// <summary>
        /// Update User Application Properties
        /// </summary>
        /// <remarks>
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        public ApiResponse< PropertiesEnvelope > CreateUserPropertiesWithHttpInfo (string userId, AppProperties properties, string aid = null)
        {
            ...
            {
                Exception exception = ExceptionFactory("CreateUserProperties", localVarResponse);
        ...
        public ApiResponse< PropertiesEnvelope > DeleteUserPropertiesWithHttpInfo (string userId, string aid = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteUserProperties", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< UserEnvelope > GetSelfWithHttpInfo ()
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetSelf", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< DeviceTypesEnvelope > GetUserDeviceTypesWithHttpInfo (string userId, int? offset = null, int? count = null, bool? includeShared = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetUserDeviceTypes", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< DevicesEnvelope > GetUserDevicesWithHttpInfo (string userId, int? offset = null, int? count = null, bool? includeProperties = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetUserDevices", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="offset">Offset for pagination. (optional)</param>
        /// <returns>RulesEnvelope</returns>
        public RulesEnvelope GetUserRules (string userId, bool? excludeDisabled = null, int? count = null, int? offset = null)
        {
             ApiResponse<RulesEnvelope> localVarResponse = GetUserRulesWithHttpInfo(userId, excludeDisabled, count, offset);
             return localVarResponse.Data;
        }
        ...
        /// <param name="offset">Offset for pagination. (optional)</param>
        /// <returns>ApiResponse of RulesEnvelope</returns>
        public ApiResponse< RulesEnvelope > GetUserRulesWithHttpInfo (string userId, bool? excludeDisabled = null, int? count = null, int? offset = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetUserRules", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="offset">Offset for pagination. (optional)</param>
        /// <returns>Task of RulesEnvelope</returns>
        public async System.Threading.Tasks.Task<RulesEnvelope> GetUserRulesAsync (string userId, bool? excludeDisabled = null, int? count = null, int? offset = null)
        {
             ApiResponse<RulesEnvelope> localVarResponse = await GetUserRulesAsyncWithHttpInfo(userId, excludeDisabled, count, offset);
             return localVarResponse.Data;
        ...
        /// <param name="offset">Offset for pagination. (optional)</param>
        /// <returns>Task of ApiResponse (RulesEnvelope)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<RulesEnvelope>> GetUserRulesAsyncWithHttpInfo (string userId, bool? excludeDisabled = null, int? count = null, int? offset = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UsersApi->GetUserRules");
        ...
        public ApiResponse< PropertiesEnvelope > UpdateUserPropertiesWithHttpInfo (string userId, AppProperties properties, string aid = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("UpdateUserProperties", localVarResponse);
                if (exception != null) throw exception;
            }
