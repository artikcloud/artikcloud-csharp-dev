...
namespace CLOUD.Artik.Api
{
    ...
    public interface IMessagesApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="CLOUD.Artik.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sdids">Device IDs for which the snapshots are requested. Max 100 device ids per call.</param>
        /// <param name="includeTimestamp">Indicates whether to return timestamps of the last update for each field. (optional)</param>
        /// <returns>SnapshotResponses</returns>
        ...
        /// <param name="sdids">Device IDs for which the snapshots are requested. Max 100 device ids per call.</param>
        /// <param name="includeTimestamp">Indicates whether to return timestamps of the last update for each field. (optional)</param>
        /// <returns>Task of SnapshotResponses</returns>
        System.Threading.Tasks.Task<SnapshotResponses> GetMessageSnapshotsAsync (string sdids, bool? includeTimestamp = null);
    ...
    public partial class MessagesApi : IMessagesApi
    {
        ...
        public ApiResponse< AggregatesHistogramResponse > GetAggregatesHistogramWithHttpInfo (long? startDate, long? endDate, string sdid = null, string field = null, string interval = null)
        {
            ...
            {
                Exception exception = ExceptionFactory("GetAggregatesHistogram", localVarResponse);
        ...
        public ApiResponse< FieldPresenceEnvelope > GetFieldPresenceWithHttpInfo (long? startDate, long? endDate, string interval, string sdid = null, string fieldPresence = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetFieldPresence", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< NormalizedMessagesEnvelope > GetLastNormalizedMessagesWithHttpInfo (int? count = null, string sdids = null, string fieldPresence = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetLastNormalizedMessages", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< AggregatesResponse > GetMessageAggregatesWithHttpInfo (string sdid, string field, long? startDate, long? endDate)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetMessageAggregates", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="includeTimestamp">Indicates whether to return timestamps of the last update for each field. (optional)</param>
        /// <returns>SnapshotResponses</returns>
        public SnapshotResponses GetMessageSnapshots (string sdids, bool? includeTimestamp = null)
        {
             ApiResponse<SnapshotResponses> localVarResponse = GetMessageSnapshotsWithHttpInfo(sdids, includeTimestamp);
             return localVarResponse.Data;
        }
        ...
        /// <param name="includeTimestamp">Indicates whether to return timestamps of the last update for each field. (optional)</param>
        /// <returns>ApiResponse of SnapshotResponses</returns>
        public ApiResponse< SnapshotResponses > GetMessageSnapshotsWithHttpInfo (string sdids, bool? includeTimestamp = null)
        {
            // verify the required parameter 'sdids' is set
            if (sdids == null)
                throw new ApiException(400, "Missing required parameter 'sdids' when calling MessagesApi->GetMessageSnapshots");

            var localVarPath = "/messages/snapshots";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetMessageSnapshots", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<SnapshotResponses>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (SnapshotResponses) Configuration.ApiClient.Deserialize(localVarResponse, typeof(SnapshotResponses)));
        ...
        /// <param name="includeTimestamp">Indicates whether to return timestamps of the last update for each field. (optional)</param>
        /// <returns>Task of SnapshotResponses</returns>
        public async System.Threading.Tasks.Task<SnapshotResponses> GetMessageSnapshotsAsync (string sdids, bool? includeTimestamp = null)
        {
             ApiResponse<SnapshotResponses> localVarResponse = await GetMessageSnapshotsAsyncWithHttpInfo(sdids, includeTimestamp);
             return localVarResponse.Data;
        ...
        /// <param name="includeTimestamp">Indicates whether to return timestamps of the last update for each field. (optional)</param>
        /// <returns>Task of ApiResponse (SnapshotResponses)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SnapshotResponses>> GetMessageSnapshotsAsyncWithHttpInfo (string sdids, bool? includeTimestamp = null)
        {
            // verify the required parameter 'sdids' is set
            if (sdids == null)
                throw new ApiException(400, "Missing required parameter 'sdids' when calling MessagesApi->GetMessageSnapshots");
        ...
        public ApiResponse< NormalizedMessagesEnvelope > GetNormalizedMessagesWithHttpInfo (string uid = null, string sdid = null, string mid = null, string fieldPresence = null, string filter = null, string offset = null, int? count = null, long? startDate = null, long? endDate = null, string order = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetNormalizedMessages", localVarResponse);
                if (exception != null) throw exception;
            }
