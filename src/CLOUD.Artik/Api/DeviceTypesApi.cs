...
namespace CLOUD.Artik.Api
{
    ...
    /// </summary>
    public interface IDeviceTypesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DeviceTypesApi : IDeviceTypesApi
    {
        ...
        public ApiResponse< ManifestVersionsEnvelope > GetAvailableManifestVersionsWithHttpInfo (string deviceTypeId)
        {
            ...
            {
                Exception exception = ExceptionFactory("GetAvailableManifestVersions", localVarResponse);
        ...
        public ApiResponse< DeviceTypeEnvelope > GetDeviceTypeWithHttpInfo (string deviceTypeId)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetDeviceType", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< ManifestPropertiesEnvelope > GetLatestManifestPropertiesWithHttpInfo (string deviceTypeId)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetLatestManifestProperties", localVarResponse);
                if (exception != null) throw exception;
            }
