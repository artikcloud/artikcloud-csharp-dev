...
namespace CLOUD.Artik.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageOut :  IEquatable<MessageOut>
    { 
        ...
        public MessageOut(string Mid = null, string Uid = null, string Sdtid = null, long? Cts = null, int? Mv = null)
        {
            this.Mid = Mid;
            this.Uid = Uid;
            this.Sdtid = Sdtid;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageOut);
        }

        /// <summary>
        /// Returns true if MessageOut instances are equal
        /// </summary>
        /// <param name="other">Instance of MessageOut to be compared</param>
        /// <returns>Boolean</returns>
