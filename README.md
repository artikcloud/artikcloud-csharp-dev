...
## Documentation for Models
 ...
 - [Model.DeviceTask](docs/DeviceTask.md)
 - [Model.DeviceTaskUpdateRequest](docs/DeviceTaskUpdateRequest.md)
 - [Model.DeviceTaskUpdateResponse](docs/DeviceTaskUpdateResponse.md)
 ...
 - [Model.DeviceTypeInfo](docs/DeviceTypeInfo.md)
 - [Model.DeviceTypeInfoEnvelope](docs/DeviceTypeInfoEnvelope.md)
 - [Model.DeviceTypesEnvelope](docs/DeviceTypesEnvelope.md)
 - [Model.DeviceTypesInfo](docs/DeviceTypesInfo.md)
 - [Model.DeviceTypesInfoEnvelope](docs/DeviceTypesInfoEnvelope.md)
 - [Model.DevicesEnvelope](docs/DevicesEnvelope.md)
 - [Model.ErrorEnvelope](docs/ErrorEnvelope.md)
 - [Model.EventFeedData](docs/EventFeedData.md)
 ...
 - [Model.MetadataEnvelope](docs/MetadataEnvelope.md)
 - [Model.MetadataPropertiesEnvelope](docs/MetadataPropertiesEnvelope.md)
 - [Model.MetadataQueryEnvelope](docs/MetadataQueryEnvelope.md)
 ...
 - [Model.TaskByDid](docs/TaskByDid.md)
 - [Model.TaskByDidList](docs/TaskByDidList.md)
 - [Model.TaskByDidListEnvelope](docs/TaskByDidListEnvelope.md)
 - [Model.TaskEnvelope](docs/TaskEnvelope.md)
 - [Model.TaskHistory](docs/TaskHistory.md)
 - [Model.TaskHistoryList](docs/TaskHistoryList.md)
 - [Model.TaskList](docs/TaskList.md)
 - [Model.TaskListEnvelope](docs/TaskListEnvelope.md)
 - [Model.TaskParameters](docs/TaskParameters.md)
 - [Model.TaskRequest](docs/TaskRequest.md)
 - [Model.TaskStatus](docs/TaskStatus.md)
 - [Model.TaskStatusCounts](docs/TaskStatusCounts.md)
 - [Model.TaskStatuses](docs/TaskStatuses.md)
 - [Model.TaskStatusesEnvelope](docs/TaskStatusesEnvelope.md)
 - [Model.TaskStatusesHistoryEnvelope](docs/TaskStatusesHistoryEnvelope.md)
 - [Model.TaskUpdateRequest](docs/TaskUpdateRequest.md)
 - [Model.TaskUpdateResponse](docs/TaskUpdateResponse.md)
 - [Model.TasksStatusCounts](docs/TasksStatusCounts.md)
